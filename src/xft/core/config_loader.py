"""Configuration loading for shared analysis dimensions."""
...
from xft.core.models import AnalysisDimensionsConfig
...
def load_dimensions_config(path: str | Path) -> AnalysisDimensionsConfig:
    ...
    if not config_path.is_dir():
        return AnalysisDimensionsConfig.model_validate(read_yaml(config_path))
    legacy_path = config_path / "analysis_dimensions.yaml"
    if legacy_path.exists():
        return AnalysisDimensionsConfig.model_validate(read_yaml(legacy_path))
