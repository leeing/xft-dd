...
from diligence.recommender.scoring import score_products
from diligence.recommender.scoring.models import ProductScoreResult, ScoringContext, ScoringRunResult
...
def _with_explainability(
    ...
    explained = sorted(explained, key=lambda rec: rec.score, reverse=True)
