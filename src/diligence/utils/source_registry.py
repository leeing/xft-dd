...
_DOMAIN_RULES: list[tuple[str, SourceInfo]] = [
    ...
    ("tianyancha.com", SourceInfo(
        source_type="commercial_registry",
        authority_level="high",
        display_name="天眼查",
        should_fetch_bias="avoid",
    )),
    ("aiqicha.baidu.com", SourceInfo(
        source_type="commercial_registry",
        authority_level="high",
        display_name="爱企查",
        should_fetch_bias="avoid",
    )),
    ("qixin.com", SourceInfo(
        source_type="commercial_registry",
        authority_level="high",
        display_name="企信宝",
        should_fetch_bias="avoid",
    )),
    ("zhipin.com", SourceInfo(
        source_type="recruiting",
        authority_level="medium",
        display_name="BOSS直聘",
        should_fetch_bias="neutral",
    )),
    ("liepin.com", SourceInfo(
        source_type="recruiting",
        authority_level="medium",
        display_name="猎聘",
        should_fetch_bias="neutral",
    )),
    ("51job.com", SourceInfo(
        source_type="recruiting",
        authority_level="medium",
        display_name="前程无忧",
        should_fetch_bias="neutral",
    ...
    ("dianping.com", SourceInfo(
        source_type="map_directory",
        authority_level="low",
        display_name="大众点评",
        should_fetch_bias="neutral",
    )),
    ("baidu.com/map", SourceInfo(
        source_type="map_directory",
        authority_level="low",
        display_name="百度地图",
        should_fetch_bias="neutral",
    )),
    ("map.baidu.com", SourceInfo(
        source_type="map_directory",
        authority_level="low",
        display_name="百度地图",
        should_fetch_bias="neutral",
